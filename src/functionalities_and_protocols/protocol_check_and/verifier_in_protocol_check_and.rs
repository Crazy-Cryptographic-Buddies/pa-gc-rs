...
struct VerifierInProtocolCheckAND;

impl VerifierInProtocolCheckAND {

    fn verify_voleith_correlations<GFVOLEitH: GFAddition + GFMultiplyingBit + Clone + Zero + Debug + PartialEq>(
        bit_vec: &BitVec,
    ...
    pub fn verify<GFVOLEitH: PartialEq + Clone + GFAddition + GFMultiplyingBit + Debug + Zero>(
        ...
        nabla_a_rep: &Vec<GFVOLEitH>,
        nabla_b_rep: &Vec<GFVOLEitH>,
        ...
        for repetition_id in 0..public_parameter.kappa {
            {
                ...
                Self::verify_voleith_correlations(
