...
impl ProverInProtocolCheckAND {
    pub fn compute_masked_bits_and_voleith_macs<GFVOLEitH: Clone + GFAdd + Zero>(
        public_parameter: &PublicParameter,
        x_bit_vec_rep: &Vec<BitVec>, voleith_mac_x_vec_rep: &Vec<GFVec<GFVOLEitH>>,
        y_bit_vec_rep: &Vec<BitVec>, voleith_mac_y_vec_rep: &Vec<GFVec<GFVOLEitH>>,
    ...
    // pub fn compute_masked_cross_bits_and_voleith_macs<GFVOLEitH>(
    //     public_parameter: &PublicParameter,
    ...
    //     z_bit_vec_rep: &Vec<BitVec>, voleith_mac_z_vec_rep: &Vec<GFVec<GFVOLEitH>>
    // ) -> (Vec<BitVec>, Vec<GFVec<GFVOLEitH>>) {
    //     let tilde_z_bit_vec_rep: Vec<BitVec> = Vec::new();
    //     let voleith_mac_tilde_z_vec_rep: Vec<GFVec<GFVOLEitH>> = Vec::new();
    //     for repetition_id in 0..public_parameter.kappa {
    //         tilde_z_bit_vec_rep.push(
    //             z_bit_vec_rep[repetition_id].vec_add(
    //                 c_bit_vec_rep[repetition_id]
    //             ).vec_add(
    //                 public_d_sum_bit_vec_rep[repetition_id].
    //             )
    //         );
    //         voleith_mac_tilde_z_vec_rep.push(voleith_mac_z_vec_rep[repetition_id].vec_add(&voleith_mac_c_vec_rep[repetition_id]));
    //     }
