...
fn test_protocol_svole() {
    ...
    let mut prover_in_all_in_one_vc = ProverInAllInOneVC::<GF2p8>::new(tau, &master_key, big_n);
    let mut verifier_in_all_in_one_vc = VerifierInAllInOneVC::<GF2p8>::new(tau, &master_key, big_n);
