...
fn main() {
    ...
    let mut all_in_one_vc_for_verifier = crate::all_in_one_vc::all_in_one_vc_for_verifier::AllInOneVCForVerifier::new(tau, &master_key, message_len);
