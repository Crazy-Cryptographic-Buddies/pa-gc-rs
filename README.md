...
This is the PoC implementation of the paper **Publicly Auditable Garbled Circuit** *([ePrint](https://ia.cr/2025/772), with authors San Ling, Chan Nam Ngo, Khai Hanh Tang, and Huaxiong Wang)*.
